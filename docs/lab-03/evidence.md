...
- Hosted CI final verification before review: GitHub Actions run `35329863392` passed **Server / Client / E2E** on exact head `a2134f23c9dc1ddde9ade97205e9f38b7648f3a3`.
