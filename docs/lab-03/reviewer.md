...
|---|---|---|
| [thananun-7203/toktickit#41](https://github.com/thananun-7203/toktickit/pull/41) | `feature/1-sprint3-engineering-contract` | Multiple Changes Requested rounds, revised, approved by `Tanaboonnnnn`, and merged on 2026-09-15 |
| [thananun-7203/toktickit#42](https://github.com/thananun-7203/toktickit/pull/42) | `feature/2-user-migration-auth` | Multiple Changes Requested rounds, revised, approved by `Tanaboonnnnn`, and merged on 2026-09-15 |
| [thananun-7203/toktickit#43](https://github.com/thananun-7203/toktickit/pull/43) | `feature/3-authenticated-requester` | Multiple Changes Requested rounds, revised, approved by `Tanaboonnnnn`, and merged on 2026-09-15 |
| [thananun-7203/toktickit#44](https://github.com/thananun-7203/toktickit/pull/44) | `feature/4-it-staff-ticket-queue` | Changes Requested, revised, approved by `Tanaboonnnnn`, and merged on 2026-09-16 |
...
### Issue 2 — User Migration, Authentication & Authorization Foundation
...
### Issue 3 — Authenticated Requester & Lab 2 Regression
...
### Issue 5 — IT Staff Ticket Detail & Operations
...
### Issue 7 — Security, Regression, E2E & Visual QA
...
The detailed per-Issue verification, review heads, merge evidence, and Issue 8 hosted-CI rounds remain recorded in the PR sections above. The final release operation is intentionally separate:
